...
namespace SIGGRAPH_2024 {
    public class TrackingSystem : MonoBehaviour {
        ...
        [SerializeField] public static InputActionProperty velocityAction;
        ...
        void Update() {
            //Update Camera
            void SetCameraPosition(Transform space, Transform camera, Vector3 position) {
                space.position = Avatar.position - Root.GetPosition() + position - camera.localPosition;
        ...
        public void SetMotionAsset(MotionAsset asset) {
            ...
            // Initialize the root transformation using the RootModule
            ...
            // Apply bone transformations and velocities to the Actor
            ...
            // Extract motion data series from various modules
        ...
        public class Tracker {
            ...
            public DeviceTransformSource TransformSource = null;
            ...
            [NonSerialized] private Transform OVRNode;
            ...
            public void Initalize(TrackingSystem ts, XRNode node) {
                ...
                Node = node;
                if(Node == XRNode.Head) {
                    OVRNode = TransformSource.head;
                }
                if(Node == XRNode.LeftHand)
                {
                    OVRNode = TransformSource.leftController;
                }
                if(Node == XRNode.RightHand) {
                    OVRNode = TransformSource.rightController;
                }
            }
            ...
            public Matrix4x4 GetTransformation() {
                if(!IsConnected()) {
                    if(TS.Asset != null) {
                        return 
                            // Retrieve bone transformation and apply local transformation
                ...
                // Return the transformation of the OVRNode in XR
                return Matrix4x4.TRS(OVRNode.position, OVRNode.rotation, Vector3.one);
            }
            ...
            public Vector3 GetVelocity() {
                ...
                // Check if an XR device is valid and retrieve its velocity
            ...
            public Matrix4x4 GetBoneTransformation(float scale) {
                // Apply inverse scaling, then get the transformation corrected by delta
