...
namespace SIGGRAPH_2024 {
    public class MotionController : MonoBehaviour {
        ...
        public void UpdateTargetControl(Transform camera) {
            ...
            if(TrackingSystem.IsConnected()) {
                ...
                if(JoystickSpace == TRANSFORM_MODE.Local) {
                    move = Quaternion.LookRotation(camera.forward.ZeroY().normalized, Vector3.up) * new Vector3(leftAxis.x, 0f, leftAxis.y) * MoveSpeed * Time.fixedDeltaTime;
                } else {
